...
export const StoreProfileScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const menuItems = [
    ...
    { icon: 'storefront-outline', label: 'Store Settings', screen: 'StoreSettings' },
    { icon: 'card-outline', label: 'Payment Settings', screen: 'PaymentMethods' },
